...
const PROMPT_VARIABLES = [
  {
    ...
    vars: [
      ...
      { name: "page_type_label", desc: "Человекочитаемый тип legal-страницы (Privacy Policy, …)" },
      ...
      { name: "legal_reference", desc: "Текст/HTML образца legal-страницы (без SERP); может быть пусто" },
      { name: "legal_reference_html", desc: "Синоним legal_reference (обратная совместимость)" },
      { name: "legal_reference_format", desc: "text или html — формат образца legal_reference" },
      { name: "legal_template_notes", desc: "Заметки к шаблону legal (инструкции для LLM)" },
